      ...
      <ScrollView stickyHeaderIndices={[0]}>
        ...
        }
        {
          <View style={styles.container}>
            ...
            <AutoHeightImage width={width-width/20} source={require('../resources/instructions/1.jpg')}/>
            ...
            <AutoHeightImage width={width-width/20} source={require('../resources/instructions/2.jpg')}/>
            ...
            <AutoHeightImage width={width-width/20} source={require('../resources/instructions/3.jpg')}/>
            ...
            <AutoHeightImage width={width-width/20} source={require('../resources/instructions/4.jpg')}/>
            <Text style={styles.paragraph}>Cuando se haya dibujado la ruta sobre el mapa, verás que en el cuadro informativo se añade información del trayecto a seguir
                ...
                Si el destino o el origen que has elegido se encuentran en el interior del edificio, la ruta te llevará hasta su entrada y en el mapa podrás seguir las rutas internas
                del lugar para guiarte.
            </Text>
            <AutoHeightImage width={width-width/20} source={require('../resources/instructions/5.jpg')}/>
            ...
            <AutoHeightImage width={width-width/20} source={require('../resources/instructions/6.jpg')}/>
            ...
            <AutoHeightImage width={width-width/20} source={require('../resources/instructions/7.jpg')}/>
